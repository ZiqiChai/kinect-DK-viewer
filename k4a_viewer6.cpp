...
//bool esc = false, show[2] = { false,false };
//
//
//void save(cv::Mat & colorFrame, int i, bool &save_flag, int &frame_count)
//{
...
//			show[i] = true;
//			tids_s[i] = thread(save, ref(colorframe_d), i, ref(save_flag), ref(frame_count));//保证第一时间开启存储程序
//			break;
//		}
//	}
//	//创建普通视频
